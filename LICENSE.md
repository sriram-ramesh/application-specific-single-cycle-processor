Preamble: This Agreement, signed on Oct 24, 2016 (hereinafter: Effective Date) governs the relationship between Whoever using this work, a Business Entity, (hereinafter: Licensee) and vhdlcodes.com, a private person whose principal place of business is Nagpur (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Cache Controller (hereinafter: The Software) created and owned by Licensor, as detailed herein
